package com.badoo.ribs.sandbox.migration_demo.container.feature
...
import com.badoo.ribs.sandbox.migration_demo.container.feature.ContainerFeature.Effect
...
internal class ContainerFeature : ActorReducerFeature<Wish, Effect, State, News>(
    initialState = State(),
